...
// fluxus->JUCE port: no GLUT — just its key constants
#include "GlutKeys.h"
#include <iostream>
#include <vector>
...
#include "GLEditor.h"
#include "PolyGlyph.h"
// fluxus->JUCE port: Interpreter.h (Racket) dropped; GetEffectParameters neutered
#include "assert.h"
#include "Unicode.h"
...
{
	// fluxus->JUCE port: text effects disabled (needed Racket scratchpad config)
}
