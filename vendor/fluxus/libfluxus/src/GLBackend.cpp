...
void GLBackend::drawArrays(RPrim prim, const RVertexArrays& v, int count,
  ...
  if (v.pos) glVertexPointer(3, GL_FLOAT, v.stride, (void*) v.pos);
  if (v.nrm) glNormalPointer(GL_FLOAT, v.stride, (void*) v.nrm);
  if (v.tex) glTexCoordPointer(3, GL_FLOAT, v.stride, (void*) v.tex);
