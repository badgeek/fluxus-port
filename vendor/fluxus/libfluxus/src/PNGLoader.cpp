...
#include <iostream>
#include <cstdlib>
// fluxus->JUCE minimal port: libpng excluded. When FLUXUS_MINIMAL_NO_PNG is
// defined the PNG load/save routines become no-op stubs (they log and return
// no image), so TexturePainter still links with zero external dependencies.
// PNG texture loading is simply unavailable in this build. Re-enable by
// dropping the macro and linking libpng.
#ifndef FLUXUS_MINIMAL_NO_PNG
#include "png.h"
#endif
#include "OpenGL.h"
#include "PNGLoader.h"
